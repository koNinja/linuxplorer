#ifndef LINUXPLORER_ENGINE_CALLBACK_TABLE_HPP_
#define LINUXPLORER_ENGINE_CALLBACK_TABLE_HPP_
...
namespace linuxplorer::engine::workers {
	...
	class LINUXPLORER_ENGINE_API callback_table {
	private:
...
#endif // LINUXPLORER_ENGINE_CALLBACK_TABLE_HPP_