#ifndef LINUXPLORER_ENGINE_REMOTE_REQUESTS_HPP_
#define LINUXPLORER_ENGINE_REMOTE_REQUESTS_HPP_

#include <engine/models/requests/io_requests.hpp>
#include <engine/models/data_range.hpp>
#include <engine/models/requests/result_drain.hpp>

#include <shell/filesystem/placeholder_info.hpp>

namespace linuxplorer::engine::models::requests::remote {
	...
	/*
		Note: This class is for the response of 'CF_CALLBACK_TYPE_FETCH_PLACEHOLDERS' callback.
	*/
	...
	/*
		Note: This class is simply intended to enumerate placeholders.
	*/
...
#endif // LINUXPLORER_ENGINE_REMOTE_REQUESTS_HPP_