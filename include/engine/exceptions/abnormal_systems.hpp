#ifndef LINUXPLORER_ENGINE_ABNORMAL_SYSTEMS_HPP_
#define LINUXPLORER_ENGINE_ABNORMAL_SYSTEMS_HPP_

#include <stdexcept>
#include <format>

namespace linuxplorer::engine::exceptions {
	...
	class fatal_runtime_exception : public std::runtime_error {
	private:
...
#endif // LINUXPLORER_ENGINE_ABNORMAL_SYSTEMS_HPP_