#ifndef LINUXPLORER_ENGINE_SESSION_KEEPALIVE_HPP_
#define LINUXPLORER_ENGINE_SESSION_KEEPALIVE_HPP_
...
namespace linuxplorer::engine::resilience {
	...
	class LINUXPLORER_ENGINE_API session_keeper {
	private:
...
#endif // LINUXPLORER_ENGINE_SESSION_KEEPALIVE_HPP_