...
namespace linuxplorer::shell::functional {
	...
	private:
		...
		std::filesystem::path m_absolute_placeholder_path;
	public:
		...
		const std::filesystem::path& get_absolute_placeholder_path() const noexcept;
	};
	...
	namespace specialized {
		...
		private:
			std::filesystem::path m_absolute_old_path;
		public:
			...
			const std::filesystem::path& get_absolute_old_path() const noexcept;
		};
