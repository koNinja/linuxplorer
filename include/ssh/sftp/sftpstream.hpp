...
namespace linuxplorer::ssh::sftp {
	constexpr std::streamsize default_buffer_size = 0x1000;
	...
	public:
		sftpbuf(::LIBSSH2_SFTP* sftp, ::LIBSSH2_SFTP_HANDLE* handle, std::streamsize buffer_size = default_buffer_size);
	};
}
