...
namespace linuxplorer::lxpsvc::models::operations {
	...
	class deletion_operation : public stateful_io_operation<internal::deletion_operation_state_traits> {
	private:
	...
	*/
	class renaming_operation : public stateful_io_operation<internal::renaming_operation_state_traits> {
	private:
		mutable std::shared_ptr<requests::result_adapter<void>> m_adapter;
	...
	*/
	...
	class hydration_operation : public stateful_io_operation<internal::hydration_operation_state_traits> {
	public:
	...
	class population_operation : public stateful_io_operation<internal::population_operation_state_traits> {
	public:
	...
	class attribute_operation : public stateful_io_operation<internal::attribute_operation_state_traits> {
	public:
